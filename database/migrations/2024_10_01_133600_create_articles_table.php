...
{
    /**
     * Run the migrations.    //php artisan migrate la 2 eme etape bech nesna3 table 
     */
    public function up(): void //methode up tesna3lek table fih par defaut id et timestamps w enty tzid les autres attributs 
    {
